...
export const updateVesselSchema = z.object({
  ...
  subcultureNumber: z.number().int().min(0).optional(),
  lastSubcultureDate: z.string().datetime().nullable().optional(),
  nextSubcultureDate: z.string().datetime().nullable().optional(),
