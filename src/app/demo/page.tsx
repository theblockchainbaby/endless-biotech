    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 md:py-28 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="mailto:york@vitroslabs.com?subject=VitrOS Demo Request">
      ...
      <section className="py-16 md:py-24 px-4 bg-primary text-primary-foreground">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div>
            <a href="mailto:york@vitroslabs.com?subject=VitrOS Demo Request&body=Hi, I'd like to schedule a personalized demo of VitrOS for my lab.">
